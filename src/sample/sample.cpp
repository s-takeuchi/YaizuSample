...
void Sample(wchar_t* IpAddr, int Port)
{
	...
	int Add1 = Soc->AddReqHandler(StkWebAppExec::STKWEBAPP_METHOD_GET | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/log/", (StkWebAppExec*)ApiGetLogInfoObj);
	ApiGetServerInfo* ApiGetServerInfoObj = new ApiGetServerInfo();
	int Add2 = Soc->AddReqHandler(StkWebAppExec::STKWEBAPP_METHOD_GET | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/server/", (StkWebAppExec*)ApiGetServerInfoObj);
	ApiGetAgentInfo* ApiGetAgentInfoObj = new ApiGetAgentInfo();
	int Add3 = Soc->AddReqHandler(StkWebAppExec::STKWEBAPP_METHOD_GET | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/agent/", (StkWebAppExec*)ApiGetAgentInfoObj);
	ApiPostAgentInfo* ApiPostAgentInfoObj = new ApiPostAgentInfo();
	int Add4 = Soc->AddReqHandler(StkWebAppExec::STKWEBAPP_METHOD_POST | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/agent/", (StkWebAppExec*)ApiPostAgentInfoObj);
	ApiGetCommandForStatus* ApiGetCommandForStatusObj = new ApiGetCommandForStatus();
	int Add5 = Soc->AddReqHandler(StkWebAppExec::STKWEBAPP_METHOD_GET | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/statuscommand/$/", (StkWebAppExec*)ApiGetCommandForStatusObj);
	ApiPostServerInfo* ApiPostServerInfoObj = new ApiPostServerInfo();
	int Add6 = Soc->AddReqHandler(StkWebAppExec::STKWEBAPP_METHOD_POST | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/server/", (StkWebAppExec*)ApiPostServerInfoObj);
	ApiGetCommand* ApiGetCommandObj = new ApiGetCommand();
	int Add7 = Soc->AddReqHandler(StkWebAppExec::STKWEBAPP_METHOD_GET | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/command/", (StkWebAppExec*)ApiGetCommandObj);
	ApiPostCommand* ApiPostCommandObj = new ApiPostCommand();
	int Add8 = Soc->AddReqHandler(StkWebAppExec::STKWEBAPP_METHOD_POST | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/command/", (StkWebAppExec*)ApiPostCommandObj);
	ApiDeleteCommand* ApiDeleteCommandObj = new ApiDeleteCommand();
	int Add9 = Soc->AddReqHandler(StkWebAppExec::STKWEBAPP_METHOD_DELETE | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/command/$/", (StkWebAppExec*)ApiDeleteCommandObj);
	ApiGetCommandForOperation* ApiGetCommandForOperationObj = new ApiGetCommandForOperation();
	int Add10 = Soc->AddReqHandler(StkWebAppExec::STKWEBAPP_METHOD_GET | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/opcommand/$/", (StkWebAppExec*)ApiGetCommandForOperationObj);
	ApiGetFile* ApiGetFileObj = new ApiGetFile();
	int Add11 = Soc->AddReqHandler(StkWebAppExec::STKWEBAPP_METHOD_GET | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/file/$/$/", (StkWebAppExec*)ApiGetFileObj);
	ApiPostFile* ApiPostFileObj = new ApiPostFile();
	int Add12 = Soc->AddReqHandler(StkWebAppExec::STKWEBAPP_METHOD_POST | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/file/", (StkWebAppExec*)ApiPostFileObj);
	ApiGetLanguage* ApiGetLanguageObj = new ApiGetLanguage();
	int Add13 = Soc->AddReqHandler(StkWebAppExec::STKWEBAPP_METHOD_GET | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/language/", (StkWebAppExec*)ApiGetLanguageObj);
	ApiGetUser* ApiGetUserObj = new ApiGetUser();
	int Add14 = Soc->AddReqHandler(StkWebAppExec::STKWEBAPP_METHOD_GET | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/user$", (StkWebAppExec*)ApiGetUserObj);

	////////// Main logic starts
	Soc->TheLoop();
	////////// Main logic ends

	int Del1 = Soc->DeleteReqHandler(StkWebAppExec::STKWEBAPP_METHOD_GET | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/log/");
	int Del2 = Soc->DeleteReqHandler(StkWebAppExec::STKWEBAPP_METHOD_GET | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/server/");
	int Del3 = Soc->DeleteReqHandler(StkWebAppExec::STKWEBAPP_METHOD_GET | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/agent/");
	int Del4 = Soc->DeleteReqHandler(StkWebAppExec::STKWEBAPP_METHOD_POST | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/agent/");
	int Del5 = Soc->DeleteReqHandler(StkWebAppExec::STKWEBAPP_METHOD_GET | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/statuscommand/$/");
	int Del6 = Soc->DeleteReqHandler(StkWebAppExec::STKWEBAPP_METHOD_POST | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/server/");
	int Del7 = Soc->DeleteReqHandler(StkWebAppExec::STKWEBAPP_METHOD_GET | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/command/");
	int Del8 = Soc->DeleteReqHandler(StkWebAppExec::STKWEBAPP_METHOD_POST | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/command/");
	int Del9 = Soc->DeleteReqHandler(StkWebAppExec::STKWEBAPP_METHOD_DELETE | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/command/$/");
	int Del10 = Soc->DeleteReqHandler(StkWebAppExec::STKWEBAPP_METHOD_GET | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/opcommand/$/");
	int Del11 = Soc->DeleteReqHandler(StkWebAppExec::STKWEBAPP_METHOD_GET | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/file/$/$/");
	int Del12 = Soc->DeleteReqHandler(StkWebAppExec::STKWEBAPP_METHOD_POST | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/file/");
	int Del13 = Soc->DeleteReqHandler(StkWebAppExec::STKWEBAPP_METHOD_GET | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/language/");
	int Del14 = Soc->DeleteReqHandler(StkWebAppExec::STKWEBAPP_METHOD_GET | StkWebAppExec::STKWEBAPP_METHOD_OPTION, L"/api/user$");
