...
public:
	...
	bool GetTargetUser(wchar_t[DA_MAXLEN_OF_USERNAME], wchar_t[DA_MAXLEN_OF_PASSWORD], int*, wchar_t[DA_MAXLEN_OF_TARGETURL]);
	int GetTargetUsers(wchar_t[DA_MAXNUM_OF_USERRECORDS][DA_MAXLEN_OF_USERNAME], wchar_t[DA_MAXNUM_OF_USERRECORDS][DA_MAXLEN_OF_PASSWORD], int[DA_MAXNUM_OF_USERRECORDS], wchar_t[DA_MAXNUM_OF_USERRECORDS][DA_MAXLEN_OF_TARGETURL]);
};
