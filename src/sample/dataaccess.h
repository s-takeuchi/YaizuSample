...
#define DA_MAXLEN_OF_CMDOUTPUT 100001
#define DA_MAXNUM_OF_RESULT 240
...
public:
	...
	bool DeleteAgentInfo(wchar_t AgtName[DA_MAXLEN_OF_AGTNAME]);
	...
	int GetCommand(int[DA_MAXNUM_OF_CMDRECORDS], wchar_t[DA_MAXNUM_OF_CMDRECORDS][DA_MAXLEN_OF_CMDNAME], int[DA_MAXNUM_OF_CMDRECORDS], char[DA_MAXNUM_OF_CMDRECORDS][DA_MAXLEN_OF_CMDSCRIPT], wchar_t[DA_MAXNUM_OF_CMDRECORDS][5][DA_MAXLEN_OF_SERVERFILENAME], wchar_t[DA_MAXNUM_OF_CMDRECORDS][5][DA_MAXLEN_OF_AGENTFILENAME]);
	int GetCommandNameById(int, wchar_t[DA_MAXLEN_OF_CMDNAME]);
	bool CheckCommandExistenceByName(wchar_t[DA_MAXLEN_OF_CMDNAME]);
	int SetCommand(int, wchar_t[DA_MAXLEN_OF_CMDNAME], int, char[DA_MAXLEN_OF_CMDSCRIPT], wchar_t[5][DA_MAXLEN_OF_SERVERFILENAME], wchar_t[5][DA_MAXLEN_OF_AGENTFILENAME]);
